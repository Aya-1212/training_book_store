...
class _NewArrivalViewState extends State<NewArrivalView> {
      ...
      if (state is NewArrivalErrorState) {
        ...
        return SizedBox(
          ...
          child: ListView.separated(
              ...
              return InkWell(
                onTap: () {
                  push(
                      context,
                      SingleProductView(
                          id: widget.newArrival.data?.products?[index].id ??
                              0));
                },
                child: Container(
                    ...
                    children: [
                      Stack(children: [
                        ClipRRect(
                          ...
                          child: Image.network(
                            widget.newArrival.data?.products?[index].image ??
                                '',
                            height: 160,
                            width: 150,
                            fit: BoxFit.fill,
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                '${widget.newArrival.data?.products?[index].discount}%',
                      ...
                      const Gap(8),
                      Text(
                        widget.newArrival.data?.products?[index].name ?? '',
                        maxLines: 1,
                      ...
                      Text(
                        'Best Seller : ${widget.newArrival.data?.products?[index].bestSeller}',
                        style: getSmallStyle(
                            color: AppColors.black,
                            fontSize: 14,
                            fontWeight: FontWeight.w600),
                      ...
                      Text(
                          '${widget.newArrival.data?.products?[index].price} EGP',
                          style: const TextStyle(
                              ...
                              fontWeight: FontWeight.w600)),
                      Text(
                        '${widget.newArrival.data?.products?[index].priceAfterDiscount} EGP',
                        style: getSmallStyle(
                          color: AppColors.purple,
                          fontSize: 16,
            ...
            itemCount: widget.newArrival.data?.products?.length ?? 6,
  ...
  //  state is NewArrivalLoadingState
  //                             ? const Center(
  //                                 child: CircularProgressIndicator(),
  //                               )
  //                             : state is NewArrivalErrorState
  //                                 ? Center(
  //                                     child: Container(
  //                                       height: 150,
  //                                       width: double.infinity,
