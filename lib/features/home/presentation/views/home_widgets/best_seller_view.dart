      ...
      if (state is BestSellerErrorState) {
        ...
        return SizedBox(
          ...
          child: ListView.separated(
              ...
              return InkWell(
                onTap: () {
                  push(
                      context,
                      SingleProductView(
                          id: widget.bestseller.data!.products![index].id ??
                              0));
                },
                child: Container(
                    ...
                    children: [
                      Stack(children: [
                        ClipRRect(
                          ...
                          child: Image.network(
                            widget.bestseller.data!.products![index].image ??
                                '',
                            height: 160,
                            width: 150,
                            fit: BoxFit.fill,
                      ...
                      const Gap(8),
                      Text(
                        widget.bestseller.data!.products![index].name ?? '',
                        maxLines: 1,
            ...
            itemCount: widget.bestseller.data?.products?.length ?? 6,
