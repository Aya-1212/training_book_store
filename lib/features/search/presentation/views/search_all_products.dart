...
class SearchAllproducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          child: ListView.separated(
              ...
              return InkWell(
                onTap: () {
                  push(
                      context,
                      SingleProductView(
                        id: allProducts.data?.products?[index].id ?? 0,
                      ));
                },
                child: Container(
                      ...
                      Stack(children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                "${allProducts.data?.products![index].discount}%",
                                //'',
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Best Seller : ${allProducts.data?.products![index].bestSeller}',
                              //'',
                             style:getBodyStyle(
                              fontSize: 17,
                                fontWeight: FontWeight.w600
                              ), //  'Best Seller : ${widget.bestseller.data!.products![index].bestSeller}',
                              
                            ),
                            Text(
                                '${allProducts.data?.products![index].price} EGP',
                                //'',
                            ...
                            Text(
                              '${allProducts.data?.products![index].priceAfterDiscount} EGP',
            ...
            itemCount: allProducts.data?.products!.length ?? 0,
